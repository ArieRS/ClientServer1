...
class pembelian extends REST_Controller {
    ...
    // show data pembelian
    function user_get() {
        $get_transaksi = $this->db->query("Select pemb.id_pembelian, pemb.id_pembeli, pemb.tanggal_beli,pemb. total_harga, pemb.id_tiket from pembeli, pembelian pemb, tiket Where pemb.id_pembeli=pembeli.id_pembeli and pemb.id_tiket=tiket.id_tiket and pemb.id_pembelian='beli16'")->result();
